...
// Example Promise that returns an array of results
const promise = new Promise((resolve, reject) => {
  // Some asynchronous operation that resolves with an array
  const resultsArray = getStudentList()
  resolve(resultsArray)
})

// Using the then() method to handle the resolved value of the Promise
promise
  .then((results) => {
    // Accessing the result array inside the then() callback
    myVar = results
    console.log(myVar) // Output: [1, 2, 3]
  })
  .catch((error) => {
    console.error(error) // Handle any errors that occur
  })

// const studentListFun = getStudentList.then((results) => {
//   console.log('studentListFun IS::::')
//   console.log(studentListFun)
// })

// const studentList = getStudentList()
// console.log('STUNNNETEDD LISSTSTTT')
